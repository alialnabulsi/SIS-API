...
class ScheduleController {
    static async createSchedule(req, res) {
        try {
            const { roomID, startTime, endTime, day, scheduleType } = req.body;
            const schedule = new Schedule(0, roomID, startTime, endTime, day, scheduleType);
    ...
    static async getScheduleByRoomAndTime(req, res) {
        try {
            const { roomID, startTime, endTime, day } = req.params;
